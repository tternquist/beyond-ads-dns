...
| # | Area | Issue | Effort | Status |
|---|------|-------|--------|--------|
| N3 | UI Client | **`App.jsx` still 2,782 lines with 142 `useState` calls** — state ownership not yet delegated to page components. Extract per-feature hooks. | High | Open |
