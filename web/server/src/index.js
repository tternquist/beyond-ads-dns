...
export function createApp(options = {}) {
  ...
  // System routes (health, CPU, resources, info, debug)
  registerSystemRoutes(app, {
    redisUrl, clickhouseEnabled, startTimestamp,
    formatBytes, readMergedConfig, defaultConfigPath, configPath,
    getContainerMemoryLimitBytes, getRaspberryPiModel, getRaspberryPiDebugInfo,
  });
